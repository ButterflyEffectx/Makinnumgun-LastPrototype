...
export default function Register() {
    ...
    return (
        <>
            <Nav />
            <div style={{ backgroundImage: `url(${bg})` }} className="min-h-screen bg-blend-multiply bg-gray-400 bg-cover bg-center flex flex-col items-center justify-center p-4">
